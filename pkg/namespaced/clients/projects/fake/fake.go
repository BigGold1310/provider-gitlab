...
type MockClient struct {
	...
	MockGetHook    func(pid any, hook int64, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectHook, *gitlab.Response, error)
	...
	MockEditHook   func(pid any, hook int64, opt *gitlab.EditProjectHookOptions, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectHook, *gitlab.Response, error)
	MockDeleteHook func(pid any, hook int64, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error)

	MockGetMember    func(pid any, user int64, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectMember, *gitlab.Response, error)
	...
	MockEditMember   func(pid any, user int64, opt *gitlab.EditProjectMemberOptions, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectMember, *gitlab.Response, error)
	MockDeleteMember func(pid any, user int64, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error)
	...
	MockDeleteDeployToken     func(pid any, deployToken int64, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error)
	MockGetProjectDeployToken func(pid any, deployToken int64, options ...gitlab.RequestOptionFunc) (*gitlab.DeployToken, *gitlab.Response, error)
	...
	MockUpdateDeployKey func(pid any, deployKey int64, opt *gitlab.UpdateDeployKeyOptions, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectDeployKey, *gitlab.Response, error)
	MockGetDeployKey    func(pid any, deployKey int64, options ...*gitlab.RequestOptionFunc) (*gitlab.ProjectDeployKey, *gitlab.Response, error)

	MockGetPipelineSchedule            func(pid any, schedule int64, options ...gitlab.RequestOptionFunc) (*gitlab.PipelineSchedule, *gitlab.Response, error)
	...
	MockEditPipelineSchedule           func(pid any, schedule int64, opt *gitlab.EditPipelineScheduleOptions, options ...gitlab.RequestOptionFunc) (*gitlab.PipelineSchedule, *gitlab.Response, error)
	MockDeletePipelineSchedule         func(pid any, schedule int64, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error)
	MockCreatePipelineScheduleVariable func(pid any, schedule int64, opt *gitlab.CreatePipelineScheduleVariableOptions, options ...gitlab.RequestOptionFunc) (*gitlab.PipelineVariable, *gitlab.Response, error)
	MockEditPipelineScheduleVariable   func(pid any, schedule int64, key string, opt *gitlab.EditPipelineScheduleVariableOptions, options ...gitlab.RequestOptionFunc) (*gitlab.PipelineVariable, *gitlab.Response, error)
	MockDeletePipelineScheduleVariable func(pid any, schedule int64, key string, options ...gitlab.RequestOptionFunc) (*gitlab.PipelineVariable, *gitlab.Response, error)
...
func (c *MockClient) GetPipelineSchedule(pid any, schedule int64, options ...gitlab.RequestOptionFunc) (*gitlab.PipelineSchedule, *gitlab.Response, error) {
...
func (c *MockClient) EditPipelineSchedule(pid any, schedule int64, opt *gitlab.EditPipelineScheduleOptions, options ...gitlab.RequestOptionFunc) (*gitlab.PipelineSchedule, *gitlab.Response, error) {
...
func (c *MockClient) DeletePipelineSchedule(pid any, schedule int64, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error) {
...
func (c *MockClient) CreatePipelineScheduleVariable(pid any, schedule int64, opt *gitlab.CreatePipelineScheduleVariableOptions, options ...gitlab.RequestOptionFunc) (*gitlab.PipelineVariable, *gitlab.Response, error) {
...
func (c *MockClient) EditPipelineScheduleVariable(pid any, schedule int64, key string, opt *gitlab.EditPipelineScheduleVariableOptions, options ...gitlab.RequestOptionFunc) (*gitlab.PipelineVariable, *gitlab.Response, error) {
...
func (c *MockClient) DeletePipelineScheduleVariable(pid any, schedule int64, key string, options ...gitlab.RequestOptionFunc) (*gitlab.PipelineVariable, *gitlab.Response, error) {
...
func (c *MockClient) GetProjectHook(pid any, hook int64, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectHook, *gitlab.Response, error) {
...
func (c *MockClient) EditProjectHook(pid any, hook int64, opt *gitlab.EditProjectHookOptions, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectHook, *gitlab.Response, error) {
	return c.MockEditHook(pid, hook, opt)
}

// DeleteProjectHook calls the underlying MockDeleteProjectHook method.
func (c *MockClient) DeleteProjectHook(pid any, hook int64, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error) {
	return c.MockDeleteHook(pid, hook)
}

// GetProjectMember calls the underlying MockGetMember method.
// GetProjectMember calls the underlying MockGetMember method.
func (c *MockClient) GetProjectMember(pid any, user int64, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectMember, *gitlab.Response, error) {
...
// EditProjectMember calls the underlying MockEditMember method.
func (c *MockClient) EditProjectMember(pid any, user int64, opt *gitlab.EditProjectMemberOptions, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectMember, *gitlab.Response, error) {
	return c.MockEditMember(pid, user, opt)
}

// DeleteProjectMember calls the underlying MockDeleteMember method.
// DeleteProjectMember calls the underlying MockDeleteMember method.
func (c *MockClient) DeleteProjectMember(pid any, user int64, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error) {
...
func (c *MockClient) DeleteProjectDeployToken(pid any, deployToken int64, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error) {
...
func (c *MockClient) GetProjectDeployToken(pid any, deployToken int64, options ...gitlab.RequestOptionFunc) (*gitlab.DeployToken, *gitlab.Response, error) {
...
func (c *MockClient) GetDeployKey(pid any, deployKey int64, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectDeployKey, *gitlab.Response, error) {
...
func (c *MockClient) DeleteDeployKey(pid any, deployKey int64, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error) {
	return c.MockDeleteDeployKey(pid, deployKey)
}

// UpdateDeployKey cals the underlying MockUpdateDeployKey
func (c *MockClient) UpdateDeployKey(pid any, deployKey int64, opt *gitlab.UpdateDeployKeyOptions, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectDeployKey, *gitlab.Response, error) {
...
func (c *MockClient) GetProjectAccessToken(pid any, id int64, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectAccessToken, *gitlab.Response, error) {
...
func (c *MockClient) UpdateProjectApprovalRule(pid any, approvalRule int64, opt *gitlab.UpdateProjectLevelRuleOptions, options ...gitlab.RequestOptionFunc) (*gitlab.ProjectApprovalRule, *gitlab.Response, error) {
	return c.MockUpdateProjectApprovalRule(pid, approvalRule, opt, options...)
}

func (c *MockClient) DeleteProjectApprovalRule(pid any, approvalRule int64, options ...gitlab.RequestOptionFunc) (*gitlab.Response, error) {
